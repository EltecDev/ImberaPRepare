        ...
        switch (action){
            ...
            case "Lectura de parámetros de operación":{
                ...
                if(data.isEmpty()){
                    ...
                    int i = 4;
                    do {
                        if (i==17 ||i==18 ||i==19 ||i==20 ||i==21 ||i==22 || i==23|| i==24 ||i==25 ||i==28 || i == 30  || i ==38 || i==39){
                            newData.add(String.valueOf(getDecimal(data.get(i))));//decimales sin punto
                        }else {
                            if (i==4||  i==6 || i==7 || i==8  || i==11 || i==12 || i==13 || i==14 || i==15   ||i==32){ //positivos y negativos de -99.0 a 99.0
